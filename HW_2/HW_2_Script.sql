...
-- идея в том что бы создать сервис что то типа госуслуг который бы мог оказывать помощь
-- при заключении простых договоров между физ и юр лицами 
-- полностью идею распишу по мре готовности так проще наверное буддет
